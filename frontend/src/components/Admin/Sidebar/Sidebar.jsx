    ...
    return (
        <aside className="sidebar z-10 sm:z-0 block min-h-screen fixed left-0 pb-14 max-h-screen w-3/4 sm:w-1/5 bg-gray-800 text-white overflow-x-hidden border-r">
            ...
            <div className="flex flex-col gap-1 bg-gray-700 p-3 rounded-lg shadow-lg mb-6 mt-28 mx-3.5 overflow-hidden">
                ...
                <div className="flex flex-col gap-0">
                    <a href="https://www.linkedin.com/in/nikhilsingh7438/" target="_blank" rel="noreferrer" className="font-medium text-lg hover:text-blue-500">Nikhil Singh</a>
                    <a href="mailto: connectwithnikhilsingh@gmail.com" className="text-gray-300 text-sm hover:text-blue-500"> connectwithnikhilsingh@gmail.com</a>
                </div>
            </div>
        </aside>
    )
