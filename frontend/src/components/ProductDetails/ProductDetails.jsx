                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    {Array(3).fill("").map((el, i) => (
                                        <p className="text-sm flex items-center gap-1" key={i}>
                                            ...
                                            <span className="font-medium ml-2">Bank Offer</span> 15% Instant discount on first Ecommerce Pay Later order of 500 and above <Link className="text-primary-blue font-medium" to="/">T&C</Link>
                                        </p>
                                    ))}
                                    {/* <!-- banks offers --> */}
