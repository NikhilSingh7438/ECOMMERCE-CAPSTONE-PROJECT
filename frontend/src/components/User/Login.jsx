                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <div className="text-center py-10 px-4 sm:px-14">
                            ...
                            <form onSubmit={handleLogin}>
                                <div className="flex flex-col w-full gap-4">
                                    ...
                                    <div className="flex flex-col gap-2.5 mt-2 mb-32">
                                        <p className="text-xs text-primary-grey text-left">By continuing, you agree to Ecommerce's <a href="https://www.Ecommerce.com/pages/terms" className="text-primary-blue"> Terms of Use</a> and <a href="https://www.Ecommerce.com/pages/privacypolicy" className="text-primary-blue"> Privacy Policy.</a></p>
                            ...
                            <Link to="/register" className="font-medium text-sm text-primary-blue">New to Ecommerce? Create an account</Link>
                        </div>
                        {/* <!-- edit info container --> */}
